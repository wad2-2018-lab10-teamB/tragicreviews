"""
Django settings for tragicreviews_project project.
...
SECRET_KEY = '6pn4!p34@*2-0jb))3=7t+noxi1=uz(8b6k)w7tuz5&5r7-@_%'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['tragicreviews.pythonanywhere.com', 'localhost', '127.0.0.1']
...
ROOT_URLCONF = 'tragicreviews_project.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'tragicreviews.context_processors.subject_list'
            ],
        },
    },
]

WSGI_APPLICATION = 'tragicreviews_project.wsgi.application'
