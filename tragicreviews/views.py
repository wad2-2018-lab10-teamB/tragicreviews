...
from tragicreviews.models import Page
from tragicreviews.models import UserProfile
from tragicreviews.forms import UserForm, UserProfileForm
from tragicreviews.forms import CategoryForm, PageForm
from django.contrib.auth import authenticate, login, logout
from django.http import HttpResponseRedirect
from django.contrib.auth.decorators import login_required
from datetime import datetime
from tragicreviews.bing_search import run_query
...
def index(request):
    ...
    return render_to_response('tragicreviews/index.html', context_dict, context)
...
def about(request):
    ...
    return render_to_response('tragicreviews/about.html', context_dict, context)
...
def category(request, category_name_url):
    ...
    return render_to_response('tragicreviews/category.html', context_dict, context)
...
def user_login(request):
    ...
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            if user.is_active:
                login(request, user)
                return HttpResponseRedirect('/tragicreviews/')
...
def restricted(request):
    ...
    context_dict = {}
    context_dict['cat_list'] = cat_list
    return render_to_response('tragicreviews/restricted.html', context_dict, context)
...
def search(request):
    ...
    context_dict['result_list'] = result_list
    return render_to_response('tragicreviews/search.html', context_dict, context)
...
def profile(request):
    ...
    return render_to_response('tragicreviews/profile.html', context_dict, context)
...
def suggest_category(request):
    ...
    return render_to_response('tragicreviews/category_list.html', {'cat_list': cat_list}, context)
...
def auto_add_page(request):
    ...
    return render_to_response('tragicreviews/page_list.html', context_dict, context)